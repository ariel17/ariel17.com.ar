...
DEPLOY_COMMANDS = {
    'default': [
        'nikola build',
        'rsync -avp --delete --progress -r -e ssh output/* ariel17:/srv/ariel17/www',
    ]
}
...
# <script type="text/javascript">stLight.options({publisher: "648f50e0-1b9d-46b0-a439-e69c71edffec", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
# </div>
...
<script>
  ...
  ga('create', 'UA-48346337-1', 'ariel17.com.ar');
  ga('send', 'pageview');
